            ...
            <div className="bg-white dark:bg-slate-800 p-5 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700">
              <div className="flex items-center justify-between gap-2 flex-wrap mb-1">
                ...
                <span
                  ...
                  className={`text-xs font-bold px-2 py-0.5 rounded-lg whitespace-nowrap shrink-0 ${npsScore >= 50 ? 'bg-green-100 text-green-700' : npsScore >= 0 ? 'bg-yellow-100 text-yellow-700' : 'bg-red-100 text-red-700'}`}
                >
                  NPS: {npsScore}
                </span>
              </div>
